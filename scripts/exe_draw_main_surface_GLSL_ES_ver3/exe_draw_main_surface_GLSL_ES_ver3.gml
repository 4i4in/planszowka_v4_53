function exe_draw_main_surface_GLSL_ES_ver3()
{
	...
	if surface_exists(terrain_cover_surface)		{	draw_surface_ext(terrain_cover_surface,dgw/2,0,0.5,0.5,0,-1,1);	};
	...
	if surface_exists(depth_surface3)		{	draw_surface_ext(depth_surface3,dgw/2,dgh/2,0.5,0.5,0,-1,1);	};

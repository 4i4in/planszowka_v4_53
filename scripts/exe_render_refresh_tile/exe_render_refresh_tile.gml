function exe_render_refresh_tile(_xx1,_yy1,_map_target_level,_this_player)
{
	...
	var _srf_size = control_array.tile_size *5; //magic number 5 of tiles 5x5 with _xx1,_yy1 in center for render
	...
	exe_map_drawing_loop_GLSL_ES_ver2();
	exe_draw_main_surface_GLSL_ES_ver4();
	...
	for(var _xx = _xx1 -1; _xx < _xx1 +2; _xx++)
		...
		//show_debug_message("_xcount : " + string(_xcount) + " | _ycount : " + string(_ycount));			
					...
					if _tile.render_pic[_this_player] != no_render_tile
						{
							sprite_delete(_tile.render_pic[_this_player]);
						}
					_tile.render_pic[_this_player] = sprite_create_from_surface(temporary_render,
